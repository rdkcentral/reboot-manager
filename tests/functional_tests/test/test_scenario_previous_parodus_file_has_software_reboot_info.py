...
def test_previous_parodus_file_has_software_reboot_info(run_reboot, run_update_prev_reboot, test_env, opt_paths):
    ...
    previous_parodus = _read_text(PREVIOUS_PARODUS)
    assert "PreviousRebootInfo" in previous_parodus
